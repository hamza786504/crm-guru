  ...
  return (
    <>
      <section className="px-2 relative pt-24 pb-20">
            ...
            <div className="flex items-start justify-center flex-wrap flex-col md:flex-row max-w-[400px] mx-auto md:max-w-full">
              <div className="w-full md:w-1/2 flex items-center justify-start mb-5">
                <div className="inner w-full md:w-11/12 flex items-center flex-row flex-nowrap justify-start">
                  <h4 className="text-purple-blue text-2xl font-normal">
                    -70%
                  </h4>
                  <p className="ms-3 relative mb-0 text-sm">
                  in manual effort across salesketing, and customer service
                    <p className="absolute -bottom-2 left-0 right-0 h-px bg-slate-200"></p>
                  </p>
                </div>
              </div>
              <div className="w-full md:w-1/2 flex items-center justify-start mb-5">
                <div className="inner w-full md:w-11/12 flex items-center flex-row flex-nowrap justify-start">
                  ...
                  <p className="ms-3 relative mb-0 text-sm">
                  in customer service ticket volume
                    <p className="absolute -bottom-2 left-0 right-0 h-px bg-slate-200"></p>
                  </p>
                </div>
              </div>
        ...
        <img
            src="/images/dummies.png"
            className="absolute bottom-0 right-0 lg:right-[5%] hidden lg:block"
            alt="dummy"
          />
      </section>
    </>
